...
DJOSER = {
    ...
    'SERIALIZERS': {},
    'EMAIL': {'password_reset': 'app.utilities.wm_password_reset.WMPasswordResetEmail'}
}
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'app.social.pipeline.wm_custom_auth_pipeline.check_email_exists',
    'social_core.pipeline.user.create_user',
    'app.social.pipeline.wm_custom_auth_pipeline.add_additional_social_userinfo',
